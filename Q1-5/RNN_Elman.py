...
class CustomSeq2SeqModel(nn.Module):
    def __init__(self, vocab_size, emb_size=300, out_elman=300, hidden_elman=300, hidden_size=300, num_classes=2):
        ...
        # Elman layer
        self.elman = Elman(emb_size, out_elman, hidden_elman)
    ...
    def forward(self, input_seq):
        ...
        # Apply Elman layer
        elman_output, _ = self.elman(embedded)
...
model = CustomSeq2SeqModel(vocab_size=vocab_size, emb_size=300, out_elman=300, hidden_elman=300, hidden_size=300, num_classes=2)
